...
public class Config
{
    ...
    private static final ForgeConfigSpec.BooleanValue GRAB_MORE_VAULTS = BUILDER
            .comment("Whether deployer should maintain a higher stack size of vaults and similar items.")
    ...
    private static final ForgeConfigSpec.IntValue CUSTOM_STACK_SIZE_SMALL = BUILDER
            .comment("What stack size deployers should attempt to maintain for items tagged with deployer_grabs_small_amount")
            .defineInRange("smallCustomStackSize", 6, 2, 32);

    private static final ForgeConfigSpec.IntValue CUSTOM_STACK_SIZE_MEDIUM = BUILDER
            .comment("What stack size deployers should attempt to maintain for items tagged with deployer_grabs_medium_amount")
            .defineInRange("mediumCustomStackSize", 16, 2, 48);

    private static final ForgeConfigSpec.IntValue CUSTOM_STACK_SIZE_LARGE = BUILDER
            .comment("What stack size deployers should attempt to maintain for items tagged with deployer_grabs_large_amount")
            .defineInRange("largeCustomStackSize", 64, 2, 64);
